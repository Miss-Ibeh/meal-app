...
const Navbar = () => {
  ...
  return (
    <div className='max-w-[1640px] mx-auto p-4 flex justify-between items-center'>
      ...
      <div className='flex items-center'>
        ...
        className='cursor-pointer'>
            {/** we add react icons: in termiinal type npm install reac-icons
    ...
    {/* search-input*/}
    <div className='bg-gray-200 flex items-center rounded-full w-{200px} px-2 sm:w-[400px] lg:w-[500px]'>
